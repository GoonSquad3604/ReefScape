...
public final class ArmConstants {
  ...
  public static final double algaeReefElbow = 0.224;
  public static final double bargeElbow = 0.294;

  public static final double processorWrist = 0.218;
  public static final double algaeReefWrist = 0.208;
  ...
  /* Ground algae intake*/
  public static final double algaeGroundWrist = 0.241;
  public static final double algaeGroundElbow = 0.110;

  /* lollipop */
  public static final double algaeLollipopWrist = 0.275;
  public static final double algaeLollipopElbow = 0.163;
