...
public class ElevatorIONeo implements ElevatorIO {
    ...
    public ElevatorIONeo(){
        ...
        rightConfig
            .idleMode(IdleMode.kBrake)
            .follow(ElevatorConstants.leftMotorID, true);
        rightConfig.encoder
            .positionConversionFactor(1000)
            .velocityConversionFactor(1000);
    ...
    public void updateInputs(ElevatorIOInputs inputs){
        ...
        inputs.HeightInInches = ElevatorConstants.homeOffset + leftMotor.getEncoder().getPosition() * ElevatorConstants.gearRatio * ElevatorConstants.pulleyCircumference;
